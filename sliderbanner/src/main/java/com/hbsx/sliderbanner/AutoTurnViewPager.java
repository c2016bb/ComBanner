...
public class AutoTurnViewPager<T> extends LoopViewPager {
    ...
    public AutoTurnViewPager setPages(SliderHolder<T> holer) {
        SliderPagerAdapter adapter = new SliderPagerAdapter(holer);
    ...
    protected AutoTurnViewPager setPages(SliderHolder<T> holer, List<T> data) {
        SliderPagerAdapter adapter = new SliderPagerAdapter(holer);
        setmDatas(data);
        adapter.setViewPager(this);
        setAdapter(adapter);
